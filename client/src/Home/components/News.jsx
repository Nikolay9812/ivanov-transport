    ...
    <div className="py-10">
      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-center gap-6 mx-auto py-10 text-md">
        <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          ...
          <a
            href="#"
            class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-first-color rounded-lg hover:bg-first-color-alt focus:ring-4 focus:outline-none focus:ring-blue-300"
          >
            Read more
            <svg
